...
# Usage: 
#
#   test4.py host file [host file [host file [...]]]
#
...
benchmarks = [
    './wrk -d 60s http://192.168.1.135:81/1kb.dat > rawlogs/test4small.log', \
    './wrk -d 60s http://192.168.1.135:82/fedora29.iso > rawlogs/test4big.log', \
]
