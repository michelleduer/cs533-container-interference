...
from _multiprocessing import Pool   # parallel computation
...
def multi_tests(img: str, stress_img: str, total_tests: int, test_name: str, processes: int=2):
    """
    ...
    :param total_tests: the total number of tests
    :param test_name: the base test name
    :param processes: total number of processes
    :return the names of tests
    """
    jobs = []
    names = []
